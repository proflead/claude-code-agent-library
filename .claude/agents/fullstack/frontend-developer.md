...
description: Use when you need react, Vue, Angular expert specializing in modern component architecture and state management.
model: sonnet
...
claude --agent frontend-developer "Create a React dashboard component with charts and data tables"

# State management
claude --agent frontend-developer "Implement Redux Toolkit state management for user authentication"
```
