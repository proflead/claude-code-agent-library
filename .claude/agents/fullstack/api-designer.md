---
name: api-designer
description: Use when you need rESTful API design, OpenAPI specifications, and API versioning strategies.
model: sonnet
...
```bash
# Design API
claude --agent api-designer "Design a RESTful API for a library management system with books, authors, and loans"

# OpenAPI spec
claude --agent api-designer "Create an OpenAPI 3.0 specification for a payment processing API"
```
