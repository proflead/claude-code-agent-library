...
description: Use when you need aPI design, authentication, database integration, and server-side logic specialist.
model: sonnet
...
```bash
# Build REST API
claude --agent backend-developer "Create a Node.js Express API for user management with CRUD operations"

# Authentication
claude --agent backend-developer "Implement JWT authentication with refresh tokens in FastAPI"
```
