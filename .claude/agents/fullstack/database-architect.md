...
description: Use when you need database schema design, normalization, query optimization, and data modeling expert.
model: sonnet
...
```bash
# Schema design
claude --agent database-architect "Design a PostgreSQL schema for an e-commerce platform with products, orders, and customers"

# Optimization
claude --agent database-architect "Optimize this user activity table for fast queries on user_id and timestamp"
```
