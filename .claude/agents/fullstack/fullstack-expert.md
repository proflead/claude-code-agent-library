...
description: Use when you need end-to-end feature implementation from frontend to backend to database.
model: sonnet
...
claude --agent fullstack-expert "Build a complete task management feature with create, read, update, delete operations"

# Real-time feature
claude --agent fullstack-expert "Implement a real-time chat with WebSockets, message persistence, and online status"
```
