...
description: Use when you need cross-platform mobile development with React Native, Flutter, and native iOS/Android.
model: sonnet
...
```bash
# React Native app
claude --agent mobile-developer "Build a React Native fitness tracking app with workout logging and progress charts"

# Flutter app
claude --agent mobile-developer "Create a Flutter shopping app with product catalog and cart functionality"
```
