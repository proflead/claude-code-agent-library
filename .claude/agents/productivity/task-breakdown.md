---
name: task-breakdown
description: Use when you need epic decomposition and story estimation for Agile development.
model: sonnet
...
```bash
claude --agent task-breakdown "Break down the user authentication epic into user stories"
claude --agent task-breakdown "Estimate these 15 user stories for sprint planning"
```
