...
description: Use when you need error analysis, stack trace interpretation, and root cause investigation specialist.
model: sonnet
...
```bash
claude --agent debug-detective "Analyze this NullPointerException stack trace"
claude --agent debug-detective "Why is my React component re-rendering infinitely?"
```
