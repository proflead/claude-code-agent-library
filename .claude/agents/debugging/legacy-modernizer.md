...
description: Use when you need legacy code refactoring, tech debt reduction, and modernization strategies.
model: sonnet
...
```bash
claude --agent legacy-modernizer "Plan migration from AngularJS to React"
claude --agent legacy-modernizer "Refactor this 2000-line God class"
```
