---
name: figma-to-html
description: Use when you need converts Figma designs to production-ready HTML/CSS/React code.
model: sonnet
...
claude --agent figma-to-html "Convert this Figma design to HTML and CSS: [Figma URL]"

# Example 2: Generate React components
claude --agent figma-to-html "Convert this Figma component library to React TypeScript components: [Figma URL]"

# Example 3: Extract design system
claude --agent figma-to-html "Analyze this Figma file and extract the design system as CSS custom properties: [Figma URL]"
```
