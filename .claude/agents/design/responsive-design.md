...
description: Use when you need mobile-first responsive design with accessibility and cross-browser support.
model: sonnet
...
claude --agent responsive-design "Make this desktop navigation responsive with mobile hamburger menu"

# Optimize for mobile
claude --agent responsive-design "Convert this desktop card grid to work on mobile devices"
```
