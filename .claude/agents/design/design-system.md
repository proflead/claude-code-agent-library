---
name: design-system
description: Use when you need creates and maintains component libraries and design tokens.
model: sonnet
...
claude --agent design-system "Create a design token system for our brand colors, typography, and spacing"

# Build component library
claude --agent design-system "Build a button component with primary, secondary, and tertiary variants"
```
