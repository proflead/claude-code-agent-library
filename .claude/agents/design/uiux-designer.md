---
name: uiux-designer
description: Use when you need user experience design expert for flows, wireframes, and design systems.
model: sonnet
...
```bash
# User flow design
claude --agent uiux-designer "Design the user flow for a checkout process with guest and registered user paths"

# Wireframe creation
claude --agent uiux-designer "Create wireframes for a dashboard showing analytics and reports"
```
