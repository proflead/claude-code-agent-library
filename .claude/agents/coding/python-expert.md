---
name: python-expert
description: Use when you need python specialist with type hints, pytest, and best practices for modern Python development.
model: sonnet
...
claude --agent python-expert "Create a type-annotated function to parse CSV files with error handling"

# Class with tests
claude --agent python-expert "Build a UserRepository class with CRUD methods and pytest tests"
```
