...
description: Use when you need modern ES6+ JavaScript and TypeScript expert with React, Node.js, and best practices.
model: sonnet
...
```bash
claude --agent javascript-expert "Create a React custom hook for data fetching with loading and error states"
claude --agent javascript-expert "Build a Node.js middleware for request validation and sanitization"
```
