---
name: sql-expert
description: Use when you need sQL optimization, database design, and query performance specialist.
model: sonnet
...
```bash
claude --agent sql-expert "Optimize this slow query that joins 5 tables"
claude --agent sql-expert "Design a schema for user permissions with roles and resources"
```
