---
name: code-reviewer
description: Use when you need automated pull request reviews focusing on quality, best practices, and maintainability.
model: sonnet
...
```bash
# Review PR
claude --agent code-reviewer "Review the changes in PR #123"

# Review specific files
claude --agent code-reviewer "Review these authentication service changes for security issues"
```
