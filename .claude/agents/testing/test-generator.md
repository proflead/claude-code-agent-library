---
name: test-generator
description: Use when you need creates unit tests, integration tests, and ensures comprehensive test coverage.
model: sonnet
...
```bash
# Generate unit tests
claude --agent test-generator "Create Jest unit tests for this UserService class"

# Integration tests
claude --agent test-generator "Create integration tests for the authentication API endpoints"
```
