...
description: Use when you need identifies vulnerabilities, enforces OWASP compliance, and security best practices.
model: sonnet
...
```bash
# Security audit
claude --agent security-auditor "Audit this authentication system for security vulnerabilities"

# Dependency scan
claude --agent security-auditor "Review package.json for known vulnerabilities"
```
