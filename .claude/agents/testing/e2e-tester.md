---
name: e2e-tester
description: Use when you need end-to-end test automation with Playwright, Cypress, and Selenium.
model: sonnet
...
```bash
# Create E2E tests
claude --agent e2e-tester "Create Playwright tests for user registration and login flows"

# Add visual testing
claude --agent e2e-tester "Add visual regression tests for the checkout page using Playwright"
```
