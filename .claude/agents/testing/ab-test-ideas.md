---
name: ab-test-ideas
description: Use when you need generates experiment hypotheses, test designs, and metrics for product optimization.
model: sonnet
...
claude --agent ab-test-ideas "Design A/B tests to improve checkout conversion rate on our e-commerce site"

# Example 2: Onboarding optimization
claude --agent ab-test-ideas "Generate test ideas for reducing user drop-off during app onboarding"

# Example 3: Feature validation
claude --agent ab-test-ideas "Design an experiment to test if adding social proof increases sign-ups"
```
