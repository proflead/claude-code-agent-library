---
name: docker-expert
description: Use when you need dockerfile optimization, multi-stage builds, and container security specialist.
model: sonnet
...
```bash
claude --agent docker-expert "Optimize this Dockerfile for a Node.js app"
claude --agent docker-expert "Create a multi-stage Dockerfile for a Go microservice"
```
