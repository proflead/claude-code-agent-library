...
description: Use when you need infrastructure as Code specialist with Terraform modules and state management.
model: sonnet
...
```bash
claude --agent terraform-expert "Create Terraform module for VPC with public/private subnets"
claude --agent terraform-expert "Design multi-environment setup with workspaces"
```
