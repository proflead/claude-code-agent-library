---
name: orchestrator
description: Use when you need multi-agent coordinator that delegates complex tasks to specialized agents.
model: sonnet
...
claude --agent orchestrator "Build a user authentication system with React frontend, Node.js backend, PostgreSQL database, and comprehensive tests"

# Example 2: Microservice architecture
claude --agent orchestrator "Create a payment processing microservice with API endpoints, database schema, error handling, and integration tests"

# Example 3: Full application
claude --agent orchestrator "Build a todo app with Next.js frontend, FastAPI backend, SQLite database, user authentication, and deployment configuration"
```
