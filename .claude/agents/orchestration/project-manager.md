...
description: Use when you need sprint planning, backlog grooming, and stakeholder coordination specialist.
model: sonnet
...
```bash
# Sprint planning
claude --agent project-manager "Plan a 2-week sprint for building user authentication feature"

# Backlog grooming
claude --agent project-manager "Prioritize and estimate these 20 user stories based on business value"
```
